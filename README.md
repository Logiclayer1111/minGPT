...
### 📊 Mapped Repository Stats (from [karpathy/minGPT](https://github.com/karpathy/minGPT))

| ⭐ Stars | 👁️ Watchers | 🍴 Forks | 📋 Issues | 👤 Subscribers |
|---------|-------------|----------|-----------|----------------|
| **24.2k** | **24.2k** | **3.2k** | **82** | **268** |

**License:** MIT License &nbsp;|&nbsp; **Language:** Python &nbsp;|&nbsp; **Default Branch:** `master` &nbsp;|&nbsp; **Created:** Aug 17, 2020

---

A PyTorch re-implementation of [GPT](https://github.com/openai/gpt-2), both training and inference.
